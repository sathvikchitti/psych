...
def questionnaire_contribution(q, has_audio, has_text):
    ...
    if not modalities:
        return {"text": 0, "audio": 0, "questionnaire": 100}
...
RECS = {
    "High": [
        ...
        "Contact a crisis line if you feel unsafe: Tele MANAS program offers free, 24/7 mental health support via the short code 14416 or toll-free number 1800-89-14416 or your local equivalent.",
...
<div class="ps-root">
  ...
  <div class="ps-header">
    <div class="ps-logo">
      ...
      <div>
        <div class="ps-logo-name">ManoDhwani</div>
    ...
    <div class="ps-header-meta">
      ...
      <div><strong>Model Version</strong> &nbsp;ManoDhwani v2.1.0</div>
    </div>
  </div>
  ...
  <div class="ps-disclaimer">
    ...
    <div class="ps-disclaimer-body">
      This report is generated by ManoDhwani, an AI-powered mental health screening tool. It is intended for
  ...
  <!-- Footer -->
  <div class="ps-footer">
    <span>ManoDhwani AI · {report_id} · Confidential</span>
...
def generate_pdf_endpoint():
    ...
    try:
        ...
        filename = f"ManoDhwani_Report_{patient_name}.pdf"
